...
import 'package:foodyn_rest/core/bloc/geolocation_bloc/geolocation_bloc.dart';
...
import 'package:foodyn_rest/core/utils/string_utils.dart';
...
import 'package:foodyn_rest/features/dashboard/presentation/widgets/aspect_ratio_image_widget.dart';
...
class _AddEateryPageState extends State<AddEateryPage> {
  ...
  void initState() {
    ...
    if (_configBloc.state.eateryTypes == null)
