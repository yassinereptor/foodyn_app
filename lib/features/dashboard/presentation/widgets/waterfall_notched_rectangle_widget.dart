...
class WaterfallNotchedRectangleWidget extends NotchedShape {
  /// Creates a [WaterfallNotchedRectangleWidget].
  ///
  /// The same object can be used to create multiple shapes.
  const WaterfallNotchedRectangleWidget();
  ...
  Path getOuterPath(Rect host, Rect? guest) {
    ...
    final p = List<Offset>.filled(6, Offset(0, 0), growable: false);
